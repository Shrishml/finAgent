...
async def overview_demo():
    ...
    return JSONResponse({
        ...
        "nudges": [
            ...
            {"icon": "💰", "title": "₹43,000/month surplus is unallocated", "severity": "optimize",
            ...
            {"icon": "🛡️", "title": "Emergency fund: 78% done", "severity": "optimize",
             "desc": "Target is 6 months — ₹80K more to go",
             "action": "View goal", "tab": "goals"},
        ...
        "data_gaps": [
            {"icon": "🏠", "label": "Real Estate", "chat": "I want to add my property details"},
            {"icon": "💳", "label": "Loans & EMIs", "chat": "I want to add my loan details"},
            {"icon": "🪙", "label": "Gold & SGBs", "chat": "I want to add my gold investments"},
            {"icon": "📊", "label": "Stocks & ESOP", "chat": "I want to add my stock holdings"},
        ],
        "has_holdings": True,
        "has_profile": True,
        "user_name": "Suraj",
